...
def plot_iterations(iterations, target=None):
    ...
    for i, img in enumerate(iterations):
        ...
        if target is None:
            ...
            # Display the RMSE
            if (i==8):
                    img1 = mpimg.imread('tiger.gif')
                    img1 = get_greyscale_image(img1)
                    img1 = reduce(img1, 4)
                    value = PSNR(img1,img)
                    print("PSNR value of compressed image with original image will be: ",value)
